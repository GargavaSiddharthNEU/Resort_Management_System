...
public class VehicleBookingPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel1);
        jLabel1.setBounds(418, 47, 129, 22);

        add(chooseVehicleDropdown);
        chooseVehicleDropdown.setBounds(465, 122, 148, 23);

        jLabel2.setText("Choose a vehicle of your choice:");
        add(jLabel2);
        jLabel2.setBounds(213, 130, 190, 17);

        jLabel3.setText("Vehicle Name:");
        add(jLabel3);
        jLabel3.setBounds(24, 207, 84, 17);
        add(vehicleNameTxt);
        vehicleNameTxt.setBounds(137, 203, 160, 23);

        jLabel4.setText("Vehicle Category:");
        add(jLabel4);
        jLabel4.setBounds(340, 207, 102, 17);
        add(vehicleCategoryTxt);
        vehicleCategoryTxt.setBounds(473, 203, 160, 23);

        jLabel5.setText("Vehicle Seater:");
        add(jLabel5);
        jLabel5.setBounds(682, 207, 87, 17);
        add(vehicleSeaterTxt);
        vehicleSeaterTxt.setBounds(797, 203, 160, 23);
        ...
        add(viewVehicleBtn);
        viewVehicleBtn.setBounds(660, 122, 102, 23);

        jLabel6.setText("Price per hour:");
        add(jLabel6);
        jLabel6.setBounds(490, 280, 120, 17);
        add(priceTxt);
        priceTxt.setBounds(649, 275, 160, 23);

        jLabel7.setText("Select Vehicle Booking Date:");
        add(jLabel7);
        jLabel7.setBounds(42, 351, 168, 17);

        jLabel8.setText("Enter Number of Hours:");
        add(jLabel8);
        jLabel8.setBounds(440, 350, 150, 17);
        add(numberOfHoursTxt);
        numberOfHoursTxt.setBounds(610, 343, 160, 23);

        vehicleBookingDateTxt.setDateFormatString("MM/dd/yyyy");
        add(vehicleBookingDateTxt);
        vehicleBookingDateTxt.setBounds(250, 343, 160, 23);
        ...
        add(jLabel9);
        jLabel9.setBounds(400, 438, 134, 17);

        jLabel10.setText("Vehicle Number:");
        add(jLabel10);
        jLabel10.setBounds(152, 279, 96, 17);
        add(vehicleNumberTxt);
        vehicleNumberTxt.setBounds(279, 275, 160, 23);
        ...
        add(jButton1);
        jButton1.setBounds(206, 398, 79, 23);

        jLabel11.setText("Latitude :");
        add(jLabel11);
        jLabel11.setBounds(310, 400, 55, 17);

        jLabel13.setText("Longitude :");
        add(jLabel13);
        jLabel13.setBounds(550, 400, 65, 17);

        latTxt.setEditable(false);
        add(latTxt);
        latTxt.setBounds(370, 400, 170, 23);

        longTxt.setEditable(false);
        add(longTxt);
        longTxt.setBounds(630, 400, 160, 23);
